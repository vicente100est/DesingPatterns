USE [master]
GO
/****** Object:  Database [DesignPatterns]    Script Date: 06/10/2022 08:50:32 p. m. ******/
CREATE DATABASE [DesignPatterns]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DesignPatterns', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\DesignPatterns.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DesignPatterns_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\DesignPatterns_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [DesignPatterns]
GO
/****** Object:  Table [dbo].[Beer]    Script Date: 06/10/2022 08:50:32 p. m. ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Brand]    Script Date: 06/10/2022 08:50:32 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
